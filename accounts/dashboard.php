                ...
                <div class="widget widget-account-invoice-three">
                    ...
                    <div class="widget-heading">
                        <div class="wallet-usr-info">
                            <div class="usr-name">
                                <span><img src="<?= $web_url ?>/ui/assets/img/<?= $row['acct_image'] ?? "imagi.jpg"?>" alt="admin-profile" class="img-fluid"> <?= $fullName ?> </span>
                            </div>
                            <div class="add">
            ...
            <span>Pending</span>
                        ...
                        <div class="invoice-list">
                            ...
                            <div class="info-detail-2">
                                    <p>Loan Balance: </p>
                                    <p class=""><span class="bill-amount text-secondary"><?= $currency ?><?php echo number_format($LoanBalance, 2, '.', ','); ?></span></p>
                                </div>
